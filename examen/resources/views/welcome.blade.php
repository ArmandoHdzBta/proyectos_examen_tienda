                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-3 m-auto">
                                <a href="{{ route('login') }}" class="btn btn-outline-success text-white">Inisiar sesión administador</a>
                            </div>
                            <div class="col-3 m-auto">
                                <a href="{{ route('usuario.login') }}" class="btn btn-outline-success text-white">Inisiar sesión usuario</a>
                            </div>
                        </div>
                    </div>
                </div>
